...
bkg_15 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_bbH_Htautau_ecm240.root", variables, weight_sf=weight_sf) # no
...
print("Export model")
fOutName = "outputs/mva/ZZZ_qqllvv/bdt_model_example.root"
...
pickle.dump(save, open("outputs/mva/ZZZ_qqllvv/bdt_model_example.pkl", "wb"))