...
parser.add_argument("-i", "--input", type=str, default="outputs/mva/ZZZ_qqllvv/bdt_model_example.pkl", help="Input pkl file")
parser.add_argument("-o", "--outDir", type=str, default="outputs/mva/ZZZ_qqllvv/plots_training", help="Output directory")
