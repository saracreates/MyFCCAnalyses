...
def load_process(fIn, variables, target=0, weight_sf=1.):
    ...
    df = tree.arrays(variables, library="pd", entry_start=0, entry_stop=700) # limit num of events for equal datasets
...
weight_sf = 1e9
sig_df = load_process("outputs/mva_multi/ZZZ_qqllvv/preselection/wzp6_ee_qqH_HZZ_llvv_ecm240.root", variables, weight_sf=weight_sf, target=2)
...
# bkg_2 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_ssH_HWW_ecm240.root", variables, weight_sf=weight_sf) #not
# bkg_3 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_ccH_HWW_ecm240.root", variables, weight_sf=weight_sf) #not
# bkg_4 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_bbH_HWW_ecm240.root", variables, weight_sf=weight_sf) #not
bkg_5 = load_process("outputs/mva_multi/ZZZ_qqllvv/preselection/p8_ee_ZZ_ecm240.root", variables, weight_sf=weight_sf, target=0) #yes
...
# bkg_16 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_eeH_HZZ_ecm240.root", variables, weight_sf=weight_sf) #no
# bkg_17 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_mumuH_HZZ_ecm240.root", variables, weight_sf=weight_sf) #no
# bkg_18 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_nunuH_HZZ_ecm240.root", variables, weight_sf=weight_sf) # yes
...
data = pd.concat([sig_df, bkg_5, bkg_12, bkg_13, bkg_14, bkg_15], ignore_index=True)
...
print("Export model")
fOutName = "outputs/mva_multi/ZZZ_qqllvv/bdt_model_multi.root"
...
pickle.dump(save, open("outputs/mva_multi/ZZZ_qqllvv/bdt_model_multi.pkl", "wb"))