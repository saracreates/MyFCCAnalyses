...
def load_process(fIn, variables, target=0, weight_sf=1., entry_stop=700):
...
# bkg_1 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_qqH_HWW_ecm240.root", variables, weight_sf=weight_sf, target=2) # not in training
# bkg_2 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_ssH_HWW_ecm240.root", variables, weight_sf=weight_sf, target=2) #not
# bkg_3 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_ccH_HWW_ecm240.root", variables, weight_sf=weight_sf, target=2) #not
# bkg_4 = load_process("outputs/mva/ZZZ_qqllvv/preselection/wzp6_ee_bbH_HWW_ecm240.root", variables, weight_sf=weight_sf, target=2) #not
...
data = pd.concat([sig_df, bkg_5, bkg_12, bkg_13, bkg_14, bkg_15, bkg_16, bkg_17], ignore_index=True)
...
print("Export model")
fOutName = "outputs/mva_multi/ZZZ_qqllvv/bdt_model_multi_all_bkg_large.root"
...
pickle.dump(save, open("outputs/mva_multi/ZZZ_qqllvv/bdt_model_multi_all_bkg_large.pkl", "wb"))